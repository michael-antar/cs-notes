...
### Hash Set (One Pass)
Instead of having 3 separate loops, keep a [[Hash Map|map]] of sets for rows, cols, and squares. Each map will contain 9 items and a set up of up to 9 numbers.
