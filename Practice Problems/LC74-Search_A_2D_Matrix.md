...
The most "textbook" solution to this problem is to use 2 variants of binary searches:
...
A clever solution pretends that the `m x n` matrix is just one big sorted `m * n` length array.
